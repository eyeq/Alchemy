...
enum class Item(val resId: Int, val color: Int) {
    EMPTY(R.drawable.item_empty, Color.parseColor("#000000")),
    ...
    ELEMENTAL_ICE(R.drawable.item_elemental, Color.parseColor("#FFFFFF")),
    ...
    ELEMENTAL_DARK(R.drawable.item_elemental, Color.parseColor("#0000FF")),
    ;
}