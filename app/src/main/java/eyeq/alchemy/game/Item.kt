...
enum class Item(val group: Group, val resId: Int, val colorId: Int, val textId: Int) {
    ...
    MAGMA(Group.MATERIAL, R.drawable.emoji_u303d, R.color.red, R.string.item_magma),
    MUD(Group.MATERIAL, R.drawable.spot, R.color.yellow_iron_oxide_hydroxide, R.string.item_mud),
    ...
    ASH(Group.MATERIAL, R.drawable.pile, R.color.gray, R.string.item_ash),
    LYE(Group.MATERIAL, R.drawable.emoji_u1f95b, R.color.gray, R.string.item_lye),
